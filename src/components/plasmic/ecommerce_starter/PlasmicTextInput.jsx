...
import * as sty from "./PlasmicTextInput.module.css"; // plasmic-import: iIewrD8sk6uB/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: lKG__lzlJ7dE/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: _dSJl6NdjXXq/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(defaultcss.all, sty.svg__z1LJa)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(defaultcss.all, sty.svg__m1SgI)}
                role={"img"}
              />
            ),
