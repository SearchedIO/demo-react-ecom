...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: 9aD9cpqpguwz/component
...
import * as sty from "./PlasmicSelect.module.css"; // plasmic-import: E0lnUZd6nv31/css
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: wBYCaAAJFEQ7/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: MGsmcgfjcyeK/icon
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__zVcrN)}
            value={"value1"}
          >
            {"Option 1"}
          </Select__Option>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__ed7Rj)}
            value={"value2"}
          >
            {"Option 2"}
          </Select__Option>
